...
int iNLevel = nlevel;
  ...
  tempR = new double [iNLevel +1];
  tR2 = new double [iNLevel +1];
  tR3 = new double [iNLevel +1];
  tR6 = new double [iNLevel +1];
  tRt = new double [iNLevel +1];
  tRs = new double [iNLevel +1];
  terma = new double [iNLevel +1];
